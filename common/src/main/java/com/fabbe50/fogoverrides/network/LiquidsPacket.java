...
public class LiquidsPacket {
    private static final ResourceLocation PACKET_ID = ResourceLocation.fromNamespaceAndPath("fogoverrides", "liquids");
    ...
    public static Packet<ClientGamePacketListener> create(boolean waterFog, boolean lavaFog) {
        return (Packet<ClientGamePacketListener>) NetworkManager.toPacket(NetworkManager.s2c(), new PacketPayload(waterFog, lavaFog), null);
    }
