...
public class SpectatorSettingsPacket {
    private static final ResourceLocation PACKET_ID = ResourceLocation.fromNamespaceAndPath("fogoverrides", "spectator_fog");
    ...
    public static class Client {
        ...
        private static void receive(PacketPayload payload, NetworkManager.PacketContext context) {
            context.queue(() -> {
                ...
                CurrentDataStorage.INSTANCE.updateSpectatorSettings(hasModFog, nearDistance, farDistance, waterNear, waterFar, lavaNear, lavaFar);
            });
        }
    }
