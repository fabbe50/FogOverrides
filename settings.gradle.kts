...
stonecutter {
    ...
    shared {
        ...
        //i would recommend to use neoforge for mc > 1.20.1, i haven't tested fogoverrides for forge on versions higher than that
        ...
        mc("neoforge", "1.20.4", "1.21.1", "1.21.3", "1.21.4", "1.21.5", "1.21.8")
    }
    create(rootProject)
}

rootProject.name = "FogOverrides"